...
| DNS                     | 1.1.1.1,1.0.0.1 | Comma separated list of DNS used by "3Proxy". For example: 8.8.4.4,8.8.8.8                | No       |
...
| DNS                | 1.1.1.1,1.0.0.1 | Comma separated list of DNS used by OpenVPN server. For example: 8.8.4.4,8.8.8.8          | No       |
